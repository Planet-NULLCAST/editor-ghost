...
module.exports = function (defaults) {
  let app = new EmberApp(defaults, {
    ...
    outputPaths: {
      app: {
        ...
        js: assetLocation('ember-quickstart.js'),
        css: {
          app: assetLocation('ember-quickstart.css'),
          // TODO: find a way to use the .min file with the lazyLoader
          'app-dark': 'assets/ember-quickstart-dark.css',
        },
      },
      vendor: {
    ...
    svgJar: {
      strategy: 'inline',
      stripPath: false,
      sourceDirs: ['public/icons', 'lib/koenig-editor/public/icons'],
      optimizer: {
        plugins: [
          { prefixIds: true },
          { cleanupIds: false },
  ...
  //   outputFile: 'assets/codemirror/codemirror.js',
  // });
  // app.import('vendor/simplemde/simplemde.js', {
  //   outputFile: 'assets/simplemde/simplemde.js',
  // });
  // }
